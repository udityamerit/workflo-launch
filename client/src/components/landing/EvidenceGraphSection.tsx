    ...
    <section className="max-w-7xl mx-auto px-6 py-32 relative z-10" id="evidence-graph">
      <div className="mb-16 max-w-3xl">
        <div className="inline-flex items-center gap-2 text-neon-green text-xs font-semibold tracking-[0.2em] uppercase mb-4 border border-neon-green/20 bg-neon-green/5 px-3.5 py-1.5 rounded-full font-mono">
          <span>ACT 05 // EVIDENCE GRAPH</span>
        </div>
        ...
        <p className="text-gray-400 text-lg mt-6 font-light leading-relaxed max-w-2xl">
          A test run should never be a black box. Workflo generates a cryptographic DAG of all execution
          artifacts—collapsing raw logs, visual traces, and state trees into a single root manifest hash.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        {/* Left: Interactive Evidence Tree */}
        <div className="lg:col-span-7 bg-[#080808] border border-gray-800 rounded-2xl p-8 relative shadow-2xl">
          <div className="flex items-center justify-between border-b border-gray-800 pb-4 mb-6 font-mono text-xs text-gray-400">
              ...
              return (
                <div
                  ...
                  className={`evidence-tree-node p-4 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    isSelected
                      ? "bg-[#111608] border-neon-green text-white"
                      : "bg-[#0c0c0c] border-gray-800/80 text-gray-300 hover:border-gray-700"
                  }`}
                >
          ...
          <div className="mt-8 p-4 rounded-xl bg-[#050505] border border-gray-800/90 flex items-center justify-between font-mono text-xs">
        ...
        <div className="lg:col-span-5 bg-[#0a0a0a] border border-gray-800 rounded-2xl p-8 flex flex-col justify-between shadow-2xl">
          <div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-800 flex items-center justify-between text-xs font-mono text-gray-400">
