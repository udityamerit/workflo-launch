    ...
    <section className="max-w-7xl mx-auto px-6 py-32 relative z-10" id="problem">
      <div className="mb-16 max-w-3xl">
        <div className="scale-badge mb-4 font-mono">
          <span>ACT 02 // THE PULL-APART PROBLEM</span>
        </div>
        ...
        <p className="text-gray-400 text-lg mt-6 font-light leading-relaxed max-w-2xl">
          Conventional test runners return a binary output: passed or failed. Like Scale AI's pull-apart
          architecture, Workflo fractures every run into inspectable, tamper-proof cryptographic layers.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-6 flex flex-col items-center">
          <div className="w-full flex items-center justify-between mb-6 pb-2 border-b border-white/[0.08]">
            ...
            >
              {isFractured ? "Collapse to Single Card" : "Pull Apart into 7 Layers"}
          ...
          <div className="w-full relative min-h-[460px] flex flex-col justify-center items-center evidence-fracture-stage">
            {!isFractured ? (
              ...
              <div
                ...
                className="w-full max-w-md p-8 bg-[#090909] border border-white/[0.08] rounded-2xl flex flex-col items-center justify-center text-center cursor-pointer shadow-2xl hover:border-neon-green/50 transition-all group scale-corner-plus"
              >
                ...
                <div className="mt-8 text-xs text-neon-green font-mono border border-neon-green/20 bg-neon-green/5 px-4 py-2 rounded-full">
                  Click to pull apart into 7 evidence layers →
                </div>
              </div>
            ) : (
                  ...
                  return (
                    <div
                      ...
                      className={`evidence-layer-card p-4 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                        isSelected
                          ...
                          : "bg-[#090909] border-white/[0.08] hover:bg-[#0f0f0f] hover:border-white/[0.18]"
                      }`}
                      style={{
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-mono text-gray-300 bg-[#000] px-2.5 py-1 rounded border border-white/[0.08]">
                          {layer.value}
                        </span>
        ...
        <div className="lg:col-span-6 bg-[#080808] border border-white/[0.08] rounded-2xl p-8 relative overflow-hidden shadow-2xl scale-corner-plus">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#050505] p-5 rounded-xl border border-white/[0.08] font-mono text-xs leading-relaxed text-gray-300">
              <div className="text-gray-500 mb-2">// Inspection Specification</div>
              <p>{currentLayer.detail}</p>
            </div>

            <div className="grid grid-cols-2 gap-4 font-mono text-xs">
              <div className="p-4 bg-[#0d0d0d] border border-white/[0.08] rounded-xl">
            ...
            <div className="pt-4 border-t border-white/[0.08] flex items-center justify-between text-xs font-mono text-gray-500">
              ...
              <span className="text-neon-green font-bold">100% Deterministic</span>
            </div>
          </div>
        </div>
      </div>
